...
If I want to access an instance of a class, I could do that by typing in:  ObjectName.method = ('name of the method)
        i.e. line 24
I can access an attribute that belongs to a class from an instance of the class, I can by using object name, followed by a dot notation and then the name of the attribute.  ObjectName
