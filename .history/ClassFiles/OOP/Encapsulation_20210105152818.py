...
ford.speed = 500  #  I can also access the speed variable directly without the method and change the value. I'm able to do this ecause there is no encapsulation in place.
