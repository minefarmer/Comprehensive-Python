...
cal = calendar.HTMLCalendar(calendar.MONDAY)  # SUNDAY is the first day of the week. == If I want to use Monday instead than enter MONDAY.
...
# The MyCal.html shows a calender
