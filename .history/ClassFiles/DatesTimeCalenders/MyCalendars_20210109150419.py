...
for days in cal.itermonthdates(2021,4)  # Loop over the days of the month by using cal.itemmonthday (2019,4), it will fetch the total number of days for that month,
