...
For loop use in tuple  # 11
Accessing elements in a tuple.  # 27
Creating a Tuple with a Tuple constructor. Tuples are immutable.  # 20
...
# animals[0] = "cheetah"  # Traceback (most recent call last):
                    # File "c:\Users\pgold\CarlsHub\Comprehensive-Python\ClassFiles\DataStructures\Tuples.py", line 38, in <module>
                    #     animals[0] = "cheetah"
