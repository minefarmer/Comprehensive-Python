...
print(mycar)  # Traceback (most recent call last):
            File "c:\Users\pgold\CarlsHub\Comprehensive-Python\ClassFiles\DataStructures\Dictionary.py", line 54, in <module>
                mycar.delete()
