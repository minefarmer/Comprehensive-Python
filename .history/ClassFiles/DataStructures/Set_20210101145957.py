...
fruits.remove("kiwi")
print(fruits)  # {'apples', 'oranges', 'berries', 'grapes', 'mango'}
...
print(animals)  # Traceback (most recent call last):
  File "c:\Users\pgold\CarlsHub\Comprehensive-Python\ClassFiles\DataStructures\Set.py", line 50, in <module>
    print(animals)
