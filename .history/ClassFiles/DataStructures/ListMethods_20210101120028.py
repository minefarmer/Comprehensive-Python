...
remove()    Removes the specified item from the list.  # 39
del()       Can remove an item or a complete list.  # 42
''' 
...
del vegetables
print(vegetables)  # NameError: name 'vegetables' is not defined
